...
const Intro = (props) => {
  return (
    <div className="w-full flex min-h-screen items-center flex-col bg-white">
        ...
        {/* <img className="absolute w-[91px] h-[115px] top-[100px] left-[185px]" alt="Remove bg" src={bulb1} />
        <img className="absolute w-[82px] h-[114px] top-[100px] left-[1500px]" alt="Remove bg" src={bulb2} /> */}
        ...
        {/* Intro */}
          <span className="absolute top-[180px] left-[500px] text-lg text-center w-[900px] text-black">
          ...
          {/* Spring Section */}
          <div className="absolute top-[350px] left-[350px] flex items-start">
            <img src={line} alt="Vector" className="absolute -bottom-3 left-1" />
            <span className="text-4xl font-bold text-black">Spring</span>
          </div>
          <span className="absolute top-[450px] left-[150px] text-lg text-black w-[500px] text-center">
          ...
          {/* Summer Section */}
          <div className="absolute top-[350px] left-[1400px] flex items-start">
          ...
          <span className="absolute top-[450px] left-[1250px] text-lg text-black w-[500px] text-center">
          ...
          {/* Autumn Section */}
          <div className="absolute top-[650px] left-[350px] flex items-start">
            <img src={line} alt="Vector" className="absolute w-[170px] -bottom-3 left-1" />
            <span className="text-4xl font-bold text-black">Autumn</span>
          </div>
          <span className="absolute top-[750px] left-[150px] text-lg text-black w-[500px] text-center">
          ...
          {/* Winter Section */}
          <div className="absolute top-[650px] left-[1400px] flex items-start">
            <img src={line} alt="Vector" className="absolute w-[170px] -bottom-3 left-1" />
            <span className="text-4xl font-bold text-black">Winter</span>
          </div>
          <span className="absolute top-[750px] left-[1250px] text-lg text-black w-[500px] text-center">
          ...
          {/* Colour Wheel */}
          <img src={Colourwheel} alt="colourwheel" className="absolute top-[400px] left-[700px] w-[500px] h-[500px]" />
